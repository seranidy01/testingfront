...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, makiPrice, account }) => {
  ...
  // We assume the token name is coin pair + lp e.g. MAKI-PLS LP, LINK-PLS LP,
  ...
  return (
    <FCard isPromotedFarm={isPromotedFarm}>
      {isPromotedFarm && farm.quoteToken.symbol === 'PLS' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
      ...
      <ExpandingWrapper expanded={showExpandableSection}>
        <DetailsSection
          ...
          infoAddress={`https://pls-info.makiswap.com/pair/${lpAddress}`}
