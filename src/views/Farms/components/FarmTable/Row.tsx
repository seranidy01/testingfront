...
const Row: React.FunctionComponent<RowPropsWithLoading> = (props) => {
  const { details, userDataReady, apr, farm, earned } = props
                ...
                return key === 'earned' ? (
                  <CellInner key={key}>
                    <CellLayout label={tableSchema[columnIndex].label}>
                      {React.createElement(cells[key], { ...defaultKey, userDataReady })}
                    </CellLayout>
                  </CellInner>
                ) : (
                  <CellLargerInner key={key}>
                    <CellLayout label={tableSchema[columnIndex].label}>
                      {isPromotedFarm && details.quoteToken.symbol === 'PLS' && <StyledRowAccent />}
                      {React.createElement(cells[key], { ...defaultKey, userDataReady })}
                    </CellLayout>
                  </CellLargerInner>
                )
