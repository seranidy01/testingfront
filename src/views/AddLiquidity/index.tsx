...
import { Currency, currencyEquals, PLS, TokenAmount, WPLS } from 'maki-pulsechain-sdk'
...
export default function AddLiquidity({
  ...
  async function onAdd() {
    ...
    if (currencyA === PLS || currencyB === PLS) {
      const tokenBIsPLS = currencyB === PLS
      ...
      args = [
        ...
        amountsMin[tokenBIsPLS ? Field.CURRENCY_B : Field.CURRENCY_A].toString(), // eth min
        account,
        deadlineFromNow,
      ]
  ...
  const handleCurrencyBSelect = useCallback(
    (currB: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        history.push(`/add/${currencyIdA || 'PLS'}/${newCurrencyIdB}`)
      }
    },
