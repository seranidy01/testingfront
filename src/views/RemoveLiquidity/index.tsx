...
import { Currency, currencyEquals, PLS, Percent, WPLS } from 'maki-pulsechain-sdk'
...
export default function RemoveLiquidity({
  ...
  async function onRemove() {
    ...
    const currencyBIsPLS = currencyB === PLS
    const oneCurrencyIsPLS = currencyA === PLS || currencyBIsPLS
  ...
  const oneCurrencyIsPLS = currencyA === PLS || currencyB === PLS
                    ...
                    <AutoColumn gap="10px">
                      ...
                      {chainId && (oneCurrencyIsWPLS || oneCurrencyIsPLS) ? (
                        <RowBetween style={{ justifyContent: 'flex-end' }}>
                          {oneCurrencyIsPLS ? (
                            <StyledInternalLink
                              to={`/remove/${currencyA === PLS ? WPLS[chainId].address : currencyIdA}/${
                                currencyB === PLS ? WPLS[chainId].address : currencyIdB
                              }`}
                            >
                              Receive WPLS
                            </StyledInternalLink>
