...
import { Pair } from 'maki-pulsechain-sdk'
import { CardBody, Text, Flex } from 'maki-toolkit'
          ...
          <CardBody>
            <AutoColumn gap="12px" style={{ width: '100%' }}>
              {/* <Flex justifyContent="center"> */}
                <GradientButton id="join-pool-button">
                  <Link  to="/add/PLS">
                    Add Liquidity    
                  </Link>
                </GradientButton>
              ...
              <div>
                ...
                <Flex justifyContent="center">
                  <Text fontSize="14px" style={{ padding: '.5rem 0 .5rem 0' }}>
                    Staked your LP tokens in a farm? <br />
