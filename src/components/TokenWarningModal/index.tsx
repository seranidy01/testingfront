    ...
    <Wrapper error={duplicateNameOrSymbol}>
      <AutoRow gap="6px">
        ...
        <AutoColumn gap="10px" justify="flex-start">
          ...
          {chainId && (
            <ExternalLink style={{ fontWeight: 400 }} href={getScanUrlWithAddr(token.address, 'token')}>
              <Blue title={token.address}>{shortenAddress(token.address)} (View on PlsScan)</Blue>
            </ExternalLink>
          )}
        </AutoColumn>
      </AutoRow>
    ...
    <Modal isOpen={isOpen} onDismiss={handleDismiss} maxHeight={90}>
      <WarningContainer className="token-warning-container">
        <AutoColumn gap="lg">
          ...
          <Text>
            Anyone can create an ERC20 token on HECO with <em>any</em> name, including creating fake versions of
