...
const PageHeader = ({ title, description, showSettings, children }: PageHeaderProps) => {
  ...
  return (
    <StyledPageHeader>
      <Flex alignItems="center">
        ...
        {(showSettings === undefined || showSettings) && <IconButton variant="text" onClick={onPresentSettings} title="Settings">
          <CogIcon />
        </IconButton>}
